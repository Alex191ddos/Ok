...
bot = telebot.TeleBot('7469813063:AAFXdpHnA_dKYgw3bWN7BnacKgrLN7KQzzc')
...
Buy From :- @HELLxuf
Official Channel :- https://t.me/+CNi7GX1ZBkE5ODE9
'''
...
def welcome_start(message):
    ...
    response = f'''👋🏻Welcome to RAJ DDOS 🚀, {user_name}! SASTA HAI KHARID LO ABHI .
🤖Try To Run This Command : /help 
✅Join :- https://t.me/+CNi7GX1ZBkE5ODE9'''
    bot.reply_to(message, response)
